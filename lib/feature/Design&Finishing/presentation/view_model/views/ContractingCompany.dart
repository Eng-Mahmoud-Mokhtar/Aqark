...
import 'ContractingDetails.dart';
import 'Widgets/ContractinyObjects.dart';
import 'Widgets/ListContractingCompany.dart';
...
class _ContractingCompaniesState extends State<ContractingCompanies> {
  ...
  Widget _buildFeaturedEngineerContainer(ContractingCompany company) {
    final screenWidth = MediaQuery.of(context).size.width;
  ...
  void _showCompanyDetails(ContractingCompany company) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ContractingDetails(company: company),
      ),
    );
  }
